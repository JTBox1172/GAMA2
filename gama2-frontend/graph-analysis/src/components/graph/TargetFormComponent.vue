    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Source and Destination Selection</h5>
        </div>
        <div class="modal-body">
          <div class="mb-3">
            <form @submit.prevent="onSubmit">
              <label class="form-label">Select Source Column</label>
              ...
              <label class="form-label">Select Destination Column</label>
